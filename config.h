...
/* commands */
static const char *dmenucmd[] = { "dmenu_run", "-fn", font, "-nb", normbgcolor, "-nf", normfgcolor, "-sb", selbgcolor, "-sf", selfgcolor, "-p", dmenuprompt, NULL };
static const char *termcmd[]  = { "xterm", "-fn", termfont, NULL };
